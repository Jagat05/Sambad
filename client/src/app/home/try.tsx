...
import { RootState } from "@/redux/store"; // Import RootState type from your store
          ...
          <div className="flex-1 flex items-center justify-center bg-white/50">
            <div className="text-center max-w-md mx-auto p-8">
              ...
              <p className="text-gray-600 mb-6">
                Select a channel or conversation from the sidebar to start
                collaborating with your team, or create a new channel to get the
                discussion started.
              </p>
